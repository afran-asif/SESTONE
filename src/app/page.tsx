...
export default function HomePage() {
  return (
    <div className="bg-gray-200 mt-0 min-h-screen flex items-center overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-center w-full">
        ...
        <div className="z-10 text-center md:text-left">
          ...
          <p className="text-black md:text-left text-center text-lg md:text-xl mt-6 mb-5 max-w-md mx-auto opacity-90 leading-relaxed">
  Experience the fusion of tradition and streetwear. Premium quality, crafted for the bold.
          ...
          <Image 
            ...
            className="relative  mb-20 hight-auto z-10 h-full w-full object-contain mb-5 drop-shadow-[0_35px_35px_rgba(0,0,0,0.5)] transition-transform duration-700"
